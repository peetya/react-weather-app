...
WeatherStatusPage.propTypes = ({
    ...
    actualHumidity: PropTypes.number.isRequired,
    actualTemperature: PropTypes.number.isRequired,
    actualWeatherConditionCode: PropTypes.number.isRequired,
    actualCityName: PropTypes.string.isRequired,
